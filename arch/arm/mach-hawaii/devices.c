...
struct kona_freq_tbl kona_freq_tbl[] = {
	...
	FTBL_INIT(1444444, PI_OPP_TURBO, 85),
	FTBL_INIT(1555555, PI_OPP_TURBO, 85),
	FTBL_INIT(1666666, PI_OPP_SUPER_TURBO, 85),
};

int temp_lmt[2][ARRAY_SIZE(kona_freq_tbl)] = {
	{TEMP_DONT_CARE, 100, TEMP_DONT_CARE, 85}, /*1GHz*/
	{TEMP_DONT_CARE, 65, 62, 58}, /*1.2GHz*/
};
